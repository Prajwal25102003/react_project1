            ...
            <form onSubmit={(event) => event.preventDefault()}>
              <div className="relative">
                ...
                <input
                  ...
                  className="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pr-14 pl-12 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden xl:w-[430px] dark:border-gray-800 dark:bg-gray-900 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30"
                />
                <button
                  type="button"
        ...
        >
          <div className="2xsm:gap-3 flex items-center gap-2">
            ...
            <div className="relative" ref={notificationsRef}>
              ...
              >
                {notifying ? (
                  <span className="absolute top-0.5 right-0 z-1 flex h-2 w-2 rounded-full bg-orange-400">
